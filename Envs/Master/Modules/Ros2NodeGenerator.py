...
from Utils.Libs import kill_tmux_session_if_exists, check_tmux_session_exists, ros_docker_path
...
class Ros2NodeGenerator:
    ...
    def run_python_subscription(self, topic):
        ...
        os.system(f'tmux send-keys -t {node_session}:{node_window} "bash {ros_docker_path}" C-m')
        time.sleep(2)
