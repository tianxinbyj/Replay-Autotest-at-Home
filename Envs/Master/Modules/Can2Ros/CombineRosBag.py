...
def merge_rosbags(input_bags, output_bag, start_time=-1.0, stop_time=1e11):
    # 初始化读取器和写入器
...
def main():
    ...
    parser.add_argument('-t', '--start_time', type=float, default=-1, help='Output ROS2 bag path')
    parser.add_argument('-p', '--stop_time', type=float, default=1e10, help='Output ROS2 bag path')
